          ...
          if (this.item) {
            ...
            this.subscription('delete_confirm', ref.componentInstance.event.subscribe(function (event) {
              if (event.reason === 'done') {
                ...
                _this3.item.reload().then(function () {
                  _this3._service.notifySuccess("Successfully reloaded driver \"".concat(_this3.item.name, "\"."));
                  ...
                  _this3._service.notifyError("Error reloading driver. Error: ".concat(err));
                });
              }
            }));
          }
            ...
            this.subscription('delete_confirm', ref.componentInstance.event.subscribe(function (event) {
              if (event.reason === 'done') {
                ...
                item["delete"]().then(function () {
                  ...
                  _this8._service.notifyError("Error deleting module. Error: ".concat(err));
                });
              }
            }));
          }
            ...
            this.subscription('modal_events', this.modal_ref.componentInstance.event.subscribe(function (event) {
              if (event.reason === 'done') {
                ...
                _this13.item["delete"]().then(function () {
                  ...
                  _this13._service.notifyError("Error deleting driver. Error: ".concat(err));
                });
              }
            }));
            this.modal_ref.afterClosed().subscribe(function () {
