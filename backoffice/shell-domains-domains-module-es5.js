            ...
            this.subscription('delete_confirm', ref.componentInstance.event.subscribe(function (event) {
              if (event.reason === 'done') {
                ...
                item["delete"]().then(function () {
                  ...
                  _this4._service.notifyError("Error deleting application. Error: ".concat(JSON.stringify(err.response || err.message || err)));
                });
              }
            }));
          }
            ...
            this.subscription('delete_confirm', ref.componentInstance.event.subscribe(function (event) {
              if (event.reason === 'done') {
                ...
                item["delete"]().then(function () {
                  ...
                  _this10._service.notifyError("Error deleting auth source. Error ".concat(JSON.stringify(err.response || err.message || err)));
            ...
            this.subscription('delete_confirm', this.modal_ref.componentInstance.event.subscribe(function (event) {
              if (event.reason === 'done') {
                ...
                _this18.item["delete"]().then(function () {
                  ...
                  _this18._service.notifyError("Error deleting domain. Error: ".concat(JSON.stringify(err.response || err.message || err)));
                });
              }
            }));
            this.modal_ref.afterClosed().subscribe(function () {
