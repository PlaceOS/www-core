        ...
        this.subscription('confirm_ref', ref.componentInstance.event.subscribe((e) => {
            if (e.reason === 'done') {
                (device.driver
                    ...
                    : this._service.Drivers.reload(device.driver_id)).then((_) => this._service.notifySuccess('Driver successfully reloaded.'), (err) => this._service.notifyError(JSON.stringify(err.response || err.message || err)));
                ref.close();
