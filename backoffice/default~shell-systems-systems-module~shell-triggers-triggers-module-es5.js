  ...
  function node_modulesAngularCdk__ivy_ngcc__Fesm2015DragDropJs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(DragRef, [{
          ...
          this._rootElement) {
            ...
            */
            function () {
              ...
              /** @type {?} */
              _this2._pointerDown, activeEventListenerOptions);
              element.addEventListener('touchstart',
              /** @type {?} */
              _this2._pointerDown, passiveEventListenerOptions);
            });
          ...
          if (boundaryElement) {
            ...
            */
            function () {
              return (
                /** @type {?} */
                _this3._containInsideBoundaryOnResize()
              );
            });
          }
        ...
        value: function _endDragSequence(event) {
          ...
          if (this._dropContainer) {
            ...
            */
            function () {
              _this4._cleanupDragArtifacts(event);

              _this4._cleanupCachedDimensions();

              _this4._dragDropRegistry.stopDragging(_this4);
            });
          } else {
            ...
            */
            function () {
              _this4.ended.next({
                source: _this4,
                distance: _this4._getDragDistance(_this4._getPointerPositionOnPage(event))
              });
            });
        ...
        value: function _cleanupDragArtifacts(event) {
          ...
          */
          function () {
            ...
            var currentIndex = container.getItemIndex(_this6);
            /** @type {?} */

            var pointerPosition = _this6._getPointerPositionOnPage(event);
            /** @type {?} */


            var distance = _this6._getDragDistance(_this6._getPointerPositionOnPage(event));
            /** @type {?} */
            ...
            _this6.dropped.next({
              ...
              previousIndex: _this6._initialIndex,
              container: container,
              previousContainer: _this6._initialContainer,
              isPointerOverContainer: isPointerOverContainer,
              distance: distance
            });

            container.drop(_this6, currentIndex, _this6._initialContainer, isPointerOverContainer, distance, _this6._initialIndex);
            _this6._dropContainer = _this6._initialContainer;
          });
        }
        /**
          ...
          if (newContainer && newContainer !== this._dropContainer) {
            ...
            */
            function () {
              ...
              /** @type {?} */
              _this7._dropContainer.exit(_this7); // Notify the new container that the item has entered.
              ...
              _this7._dropContainer.enter(_this7, x, y, newContainer === _this7._initialContainer && // If we're re-entering the initial container and sorting is disabled,
              // put item the into its starting index to begin with.
              newContainer.sortingDisabled ? _this7._initialIndex : undefined);
              ...
              _this7.entered.next({
                ...
                currentIndex:
                /** @type {?} */
                newContainer.getItemIndex(_this7)
              });
            });
          }
            ...
            function (resolve) {
              ...
              */
              function handler(event) {
                if (!event || event.target === _this8._preview && event.propertyName === 'transform') {
                  _this8._preview.removeEventListener('transitionend', handler);
              ...
              _this8._preview.addEventListener('transitionend', handler);
            });
          });
        }
        /**
        ...
        value: function _updateOnScroll() {
          ...
          var currentScrollPosition = this._viewportRuler.getViewportScrollPosition(); // ClientRect dimensions are based on the page's scroll position so
    ...
    function () {
      ...
      function DropListRef(element, _dragDropRegistry, _document, _ngZone, _viewportRuler) {
        ...
        */
        function () {
          _this9._stopScrolling();

          Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["interval"])(0, rxjs__WEBPACK_IMPORTED_MODULE_5__["animationFrameScheduler"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(_this9._stopScrollTimers)).subscribe(
          /**
          * @return {?}
          */
          function () {
            /** @type {?} */
            var node = _this9._scrollNode;

            if (_this9._verticalScrollDirection === 1
            /* UP */
            ) {
                incrementVerticalScroll(node, -AUTO_SCROLL_STEP);
              } else if (_this9._verticalScrollDirection === 2
            /* DOWN */
            ) {
                incrementVerticalScroll(node, AUTO_SCROLL_STEP);
              }

            if (_this9._horizontalScrollDirection === 1
            /* LEFT */
            ) {
                incrementHorizontalScroll(node, -AUTO_SCROLL_STEP);
              } else if (_this9._horizontalScrollDirection === 2
            /* RIGHT */
            ) {
                incrementHorizontalScroll(node, AUTO_SCROLL_STEP);
              }
      ...
      _createClass(DropListRef, [{
        ...
        value: function start() {
          ...
          */
          function (sibling) {
            return sibling._startReceiving(_this10);
          });
        ...
        value: function _startScrollingIfNecessary(pointerX, pointerY) {
          ...
          */
          function (position, element) {
            ...
            if (element === _this12._document || !position.clientRect || scrollNode) {
              return;
            }
        ...
        value: function _cacheParentPositions() {
          ...
          */
          function (element) {
            ...
            if (element === _this13.element) {
              _this13._clientRect = clientRect;
            }

            _this13._parentPositions.set(element, {
              scrollPosition: {
          ...
          */
          function (event) {
            if (_this17.isDragging()) {
              ...
              var position = _this17._parentPositions.get(target);
              ...
              if (position) {
                ...
                if (target === _this17._document) {
                  /** @type {?} */
                  var scrollPosition =
                  /** @type {?} */
                  _this17._viewportRuler.getViewportScrollPosition();
                ...
                _this17._updateAfterScroll(target, newTop, newLeft);
              }
        ...
        value: function startDragging(drag, event) {
          ...
          if (this._activeDragInstances.size === 1) {
            ...
            this._globalListeners.set(moveEvent, {
              ...
              */
              function handler(e) {
                return _this20.pointerMove.next(
                /** @type {?} */
                e);
              },
            ...
            */
            function () {
              _this20._globalListeners.forEach(
              /**
              * @param {?} config
              * @param {?} name
              * @return {?}
    ...
    function () {
      ...
      function CdkDrag(element, dropContainer, _document, _ngZone, _viewContainerRef, config, _dir, dragDrop, _changeDetectorRef) {
        ...
        */
        function (observer) {
          /** @type {?} */
          var subscription = _this23._dragRef.moved.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(
          /**
          * @param {?} movedEvent
          * @return {?}
          */
          ...
          */
          function () {
            ...
            */
            ...
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(_this24._destroyed)).subscribe(
            /**
      ...
      _createClass(CdkDropList, [{
        ...
        value: function _setupInputSyncSubscription(ref) {
          ...
          */
          function () {
            /** @type {?} */
            var siblings = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_4__["coerceArray"])(_this28.connectedTo).map(
            /**
            * @param {?} drop
            * @return {?}
            */
            ...
            if (!_this28._scrollableParentsResolved && _this28._scrollDispatcher) {
              /** @type {?} */
              var scrollableParents = _this28._scrollDispatcher.getAncestorScrollContainers(_this28.element).map(
              /**
              * @param {?} scrollable
              * @return {?}
              */
