...
function RepositoryAboutComponent_div_0_ng_container_9_Template(rf, ctx) { if (rf & 1) {
...
function RepositoryAboutComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function RepositoryAboutComponent_div_0_Template_button_tapped_8_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.pullLatestCommit(); });
...
const _c3 = function (a2, a3) { return { id: "drivers", name: "Drivers", count: a2, icon: a3 }; };
...
RepositoriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: RepositoriesComponent, selectors: [["app-repositories"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 5, vars: 17, consts: [[1, "container"], [1, "sidebar"], ["heading", "Repositories", 3, "module", "close", "event"], [3, "touchrelease"], ["name", "repository", "route", "repositories", 3, "item", "loading", "tabs", "event"]], template: function RepositoriesComponent_Template(rf, ctx) { if (rf & 1) {
